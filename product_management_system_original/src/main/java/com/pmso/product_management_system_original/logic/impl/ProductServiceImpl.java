...
public class ProductServiceImpl implements ProductService {
    ...
    public void addProduct(ProductDto productDto) throws IOException {
        ...
        String imageName = UUID.randomUUID().toString() + "_" + productDto.getImage().getOriginalFilename();
        ObjectMetadata metadata = new ObjectMetadata();
        metadata.setContentType(productDto.getImage().getContentType());
        metadata.setContentLength(productDto.getImage().getSize());
        amazonS3.putObject(new PutObjectRequest(
                bucketName, imageName, productDto.getImage().getInputStream(), metadata)
        );
